...
export async function seed(knex: Knex): Promise<void> {
    // Deletes ALL existing entries
      ...
      await knex("questions").insert([
          { id:1, question: "What is you COVID-19 test result?",option_0:"positive test result", option_1:"negative test result", option_2:"I have not received the test result yet",option_3:"I did not take a test", type:"multiple choice"},
