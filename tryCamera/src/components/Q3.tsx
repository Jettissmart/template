...
const Q3: React.FC = () => {
    const gISymptoms=[
        { id: 11, symptom: "vomiting", level:0 },
        { id: 12, symptom: "diarrhea", level:0 },
        { id: 13, symptom: "abdominal pain", level:0 },


        // { id: 1, symptom: "fever", level:0},
        { id: 2, symptom: "cough", level:0},
        { id: 3, symptom: "runny nose", level:0 },
        { id: 4, symptom: "headache", level:0 },
        { id: 5, symptom: "sore throat",level:0 },
        { id: 6, symptom: "muscle aches", level:0 },
     

      
        { id: 7, symptom: "difficulty breathing", level:0 },
        { id: 8, symptom: "chest pain", level:0 },
        { id: 9, symptom: "loss of taste or smell", level:0 },
        { id: 10, symptom: "new confusion", level:0 },


        { id: 14, symptom: "fatigue", level:0 },
        { id: 15, symptom: "feeling cold", level:0 },
        // { id: 15, symptom: "sputum", level:0 }, color? amount? remove?
       //other
